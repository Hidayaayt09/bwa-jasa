                            ...
                            <div class="bg-white rounded-xl">
                                <section class="pt-6 pb-20 mx-8 w-auth">
                                    <div class="grid gap-5 md:grid-cols-12">
                                        ...
                                        <div class="p-10 lg:col-span-6 md:col-span-12">
                                            <a type="text" class="inline-flex justify-center px-50 py-50 mb-50 text-xs font-medium text-gray-700 bg-gray-100 border border-transparent rounded-lg hover:bg-gray-300 focus:outline-none focus:ring-50 focus:ring-offset-50 focus:ring-gray-500">

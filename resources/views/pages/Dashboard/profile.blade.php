                                    ...
                                    <div class="">
                                        <div class="px-4 py-5 sm:p-6">
                                            <div class="grid grid-cols-6 gap-6">
                                                ...
                                                <div class="col-span-6">
                                                    <label for="biograpy" class="block mb-3 font-medium text-gray-700 text-md">Biografi</label>
                                                    <textarea placeholder="Enter your biography here.." type="text" name="biograpy" id="biograpy" autocomplete="biograpy" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" rows="4">{{$user->detail_user->biograpy ?? ''}}</textarea>
                                                
                                                    @if ($errors->has('biograpy'))
                                                    <p class="text-red-500 mb-3 text-sm">{{ errors->first('biograpy') }}</p>
                                                    @endif
